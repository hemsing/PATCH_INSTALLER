 ...
 * 
 * public class WindowsOperatingSystemHelperJunitTest extends TestCase{
 * 
 ...
 */ /*
	 ...
	 * 
	 * logger.info(" service_stop_name ="+WindowsOperatingSystemHelper.
	 * startService(service_stop_name));
	 * logger.info(" Service start test "+WindowsOperatingSystemHelper.
	 * startService(service_start_name)); logger.info(" task_kill_name ="+
...
// @Test
/*
 * public void testServiceStop() throws Exception { boolean returnVal =
